...
class Setup_Country extends Component {
    constructor(props) {
        super(props);
        this.state = {
            Get_Country: [],
    ...
    Get_Country() {
        axios.get(SessionManager.API+"Get_Country.php?")
            .then(result => {
              this.setState({
                    Get_Country: result.data[0].data,
    ...
    editModalUser() {
        ...
        axios.get(SessionManager.API+"EditCountry.php?id=" + obj.edituserid + "&Country_name=" + obj.country_name)
            .then(result => {
               this.setState({
                    Get_Country: result.data[0].data,
                    selectedUser: result.data[0].data
    ...
    deleteUser(val) {
    axios.get(SessionManager.API+"DeleteCountry.php?id=" + val.Country_id)
            .then(result => {
                this.setState({
                    Get_Country: result.data[0].data,
                    selectedUser: result.data[0].data
    ...
    AddUser() {
      ...
      axios.get(SessionManager.API+"Add_Country.php?Country_name=" + obj.country_name + "&CreatedDate=" + obj.CreatedDate + "&CreatedBy=" + obj.CreatedBy)
            .then(result => {
    ...
    searchUser() {
        let obj = {
            ...
            Product: this.state.search_country,
            FullName: this.state.search_name,
            Email: this.state.search_email
        }
      let record = this.state.Get_Country.filter(a => a.Country_name == this.state.search_country  || a.FullName == this.state.search_name || a.Email == this.state.search_email)
      this.setState({
            selectedUser: record
        })
    }
       ...
       let roles = [];
        ...
        if (this.state.ddl.length > 0) {
           roles = this.state.ddl[0].data1
            ...
            // setup_user = this.state.Get_Country[0].record;
        }
                                ...
                                <form style={{ marginTop: '40px' }}>
                                    <div className="form-group row mt-2">
                                        ...
                                        <div className="col-sm-3">
                                            ...
                                            <input name="search_country" value={this.state.search_country} onChange={this.searchOnchange} type="text" className="form-control txt_SearchUserName " />
                                        </div>
                                        <div className="col-sm-3">
                                ...
                                <div class="form-group">
                                    <div class="modal-body" style={{ paddingBottom: '10px', borderBottomWidth: '10px', paddingTop: '10px', height: 'auto' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-lg-12">Country Name </label>
                                            <div class="col-lg-12">
                                                <input type="text" name="country_name" value={this.state.country_name} onChange={this.AddOnChange} className="form-control txt_SearchEmail " /><span class="help-block m-b-none"></span>
                                            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Setup_Country);
