...
class Setup_Hall extends Component {
    constructor(props) {
        super(props);
        this.state = {
            Get_Hall: [],
    ...
    Get_Hall() {
        axios.get(SessionManager.API + "Get_Hall.php?")
            .then(result => {
                this.setState({
                    Get_Hall: result.data[0].data,
    ...
    editModalUser() {
        ...
        console.log("obj", obj);
        axios.get(SessionManager.API + "EditHall.php?id=" + obj.edituserid + "&Hall_Name=" + obj.Hall_name)
            .then(result => {
                this.setState({
                    Get_Hall: result.data[0].data,
                    selectedUser: result.data[0].data
    ...
    deleteUser(val) {
        console.log("val", val);
        axios.get(SessionManager.API + "DeleteHall.php?id=" + val.Hall_id)
            .then(result => {
                this.setState({
                    Get_Hall: result.data[0].data,
                    selectedUser: result.data[0].data
    ...
    AddUser() {
        ...
        axios.get(SessionManager.API + "Add_Hall.php?Hall_Name=" + obj.Hall_name + "&CreatedDate=" + obj.CreatedDate + "&CreatedBy=" + obj.CreatedBy)
            .then(result => {
    ...
    searchUser() {
        let obj = {
            ...
            Product: this.state.search_hall,
            FullName: this.state.search_name,
            Email: this.state.search_email
        }
        let record = this.state.Get_Hall.filter(a => a.Hall_Name == this.state.search_hall || a.FullName == this.state.search_name || a.Email == this.state.search_email)
        this.setState({
            selectedUser: record
        })
    }
                                ...
                                <form style={{ marginTop: '40px' }}>
                                    <div className="form-group row mt-2">
                                        ...
                                        <div className="col-sm-3">
                                            ...
                                            <input name="search_hall" value={this.state.search_hall} onChange={this.searchOnchange} type="text" className="form-control txt_SearchUserName " />
                                        </div>
                                        <div className="col-sm-3">
                                ...
                                <div class="form-group">
                                    <div class="modal-body" style={{ paddingBottom: '10px', borderBottomWidth: '10px', paddingTop: '10px', height: 'auto' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-lg-12">Hall Name </label>
                                            <div class="col-lg-12">
                                                <input type="text" name="Hall_name" value={this.state.Hall_name} onChange={this.AddOnChange} className="form-control txt_SearchEmail " /><span class="help-block m-b-none"></span>
                                            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Setup_Hall);
